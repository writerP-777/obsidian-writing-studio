...
- The launcher's new-project button is a boxed "+" icon matching the binder's project-control buttons, and the binder's project selector carries the same project-switch chevron as the launcher's switcher. (#233 audit)
