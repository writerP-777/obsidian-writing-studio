  ...
  private renderSiteConfig(container: HTMLElement, site: WordPressSite, index: number): void {
    ...
    new Setting(siteEl)
      .addButton(b => b
        ...
        // eslint-disable-next-line @typescript-eslint/no-deprecated -- setDestructive() requires minAppVersion 1.13.0; setWarning() is the compatible fallback for minAppVersion 1.8.7
        .setWarning()
        .onClick(async () => {
