...
1. Run: Get-Date — use its output as the authoritative date and day of week for this session (any date reasoning must come from this output, never from mental derivation)
2. Read CONTEXT.md
